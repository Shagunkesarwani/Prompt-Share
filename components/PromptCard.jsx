  ...
  return (
    <div className='prompt_card'>
      ...
      items-start gap-5">
         ...
         items-centre gap-3 cursor-pointer"
          ...
          <div className='flex flex-col'>
                <h3 className='blue_gradient font-santoshi font-bold
                '>
